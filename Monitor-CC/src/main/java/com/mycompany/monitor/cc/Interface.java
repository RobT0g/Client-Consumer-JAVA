...
public class Interface extends javax.swing.JFrame {
    ...
    public Interface(Processor p) {
        initComponents();
        pros = p;
        pros.setOutput(this.buffer, this.Feed1, this.Feed2);
        consumer = new Thread(new Consumer(pros));
        producer = new Thread(new Producer(pros));
    }
     ...
     */
    public static void main(String args[], Processor p) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interface(p).setVisible(true);
            }
        });
         try{
            Thread.sleep(2000);
